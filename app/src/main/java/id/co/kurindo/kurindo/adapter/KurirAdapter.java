 ...
 * Created by DwiM on 11/9/2016.
 */
public class KurirAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
   ...
   // private String[] bgColors;
    ...
    public KurirAdapter(Context context, List<User> data, OnItemClickListener mOnItemClickListener) {
        //super(context, data);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        ((MyItemHolder) holder).approvedBtn.setVisibility(View.VISIBLE);
        ((MyItemHolder) holder).approvedBtn.setOnClickListener(new View.OnClickListener() {
            @Override
