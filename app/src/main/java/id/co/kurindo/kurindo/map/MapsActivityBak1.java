...
public class MapsActivityBak1 extends KurindoActivity implements OnMapReadyCallback, View.OnClickListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener{
    ...
    public void reDrawMarker(){
        ...
        if(destination != null && destination.getLocation() != null){
            ...
            destinationMarker = mMap.addMarker(new MarkerOptions().position(destination.getLocation()).title(title).icon(BitmapDescriptorFactory.fromResource(R.drawable.destination_pin)));
        }
        if(origin != null && origin.getLocation() != null){
