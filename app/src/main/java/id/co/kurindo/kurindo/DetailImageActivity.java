...
public class DetailImageActivity extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            data = getIntent().getParcelableArrayListExtra("orders");
...
*/
        ...
        public class SectionsPagerAdapter extends FragmentPagerAdapter {
            ...
            public Fragment getItem(int position) {
                ...
                return PlaceholderFragment.newInstance(position, model.getName(), model.getUrl());
            }
        ...
        public static class PlaceholderFragment extends Fragment {
            ...
            public View onCreateView(LayoutInflater inflater, ViewGroup container,
                ...
                View rootView = inflater.inflate(R.layout.fragment_slide_single, container, false);
