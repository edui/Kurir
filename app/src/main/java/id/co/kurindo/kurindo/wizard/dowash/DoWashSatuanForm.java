...
public class DoWashSatuanForm extends BaseStepFragment implements Step {
...
*/
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflateAndBind(inflater, container, R.layout.fragment_dowash_satuan);
    ...
    public static Fragment newInstance() {
        ...
        DoWashSatuanForm f = new DoWashSatuanForm();
