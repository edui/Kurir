...
public class BaseUtil {
	...
	public static void registerAlarm(Context context, Intent intent,
		...
		LogUtil.logD(TAG, "register" + requestCode + "  " + l / 1000);
	}
	...
	public static void openAutoStartSetting(Context context) {
		try {
			context.startActivity(getAutoStartIntent(context));
