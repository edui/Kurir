...
public class RecipientAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
   ...
   // private String[] bgColors;
    ...
    public RecipientAdapter(Context context, List<Recipient> data) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        ((MyItemHolder) holder).phone.setText(r.getTelepon());

        if(r.getName().isEmpty()) ((MyItemHolder) holder).name.setVisibility(View.GONE);
        if(r.getTelepon().isEmpty()) ((MyItemHolder) holder).phone.setVisibility(View.GONE);
